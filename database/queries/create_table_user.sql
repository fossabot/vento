...
(
    ...
    product_id text COLLATE pg_catalog."default" DEFAULT 'bbb3a2e0-52e2-11ea-9422-1978c4a70a50'NOT NULL,
    dept_id text COLLATE pg_catalog."default" DEFAULT '283802a0-52e1-11ea-b891-cd988dbdc9bf' NOT NULL,
