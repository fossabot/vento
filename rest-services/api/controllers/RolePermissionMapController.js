...
module.exports = {
    ...
    create: async function (req, res) {
        ...
        sails.log(`Created the rolePermissionMap(s) successfully: ${
            JSON.stringify(createdRolePermissionMaps)
        }`);
    ...
    get: async function (req, res) {
        ...
        sails.log(`Fetched all the rolePermissionMaps successfully: ${
            JSON.stringify(rolePermissionMaps)
        }`);
    ...
    getById: async function (req, res) {
        ...
        sails.log(`Fetched the rolePermissionMap details by ${id}: ${
            JSON.stringify(rolePermissionMap)
        }`);
    ...
    update: async function (req, res) {
        ...
        let updatedRolePermissionMap = await RolePermissionMap.updateOne({id}).set(payload);

        if (updatedRolePermissionMap) {
            sails.log(`Updated the rolePermissionMap of id ${id} with ${
