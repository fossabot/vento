...
module.exports = {
    create: async function (req, res) {
        ...
        sails.log(`Created the AssetConsumerMap(s) successfully: ${
            JSON.stringify(createdAssetConsumerMaps)
        }`);
    ...
    get: async function (req, res) {
        ...
        sails.log(`Fetched all the AssetConsumerMaps successfully: ${
            JSON.stringify(assetConsumerMaps)
        }`);
    ...
    getById: async function (req, res) {
        ...
        sails.log(`Fetched the AssetConsumerMap details by ${id}: ${
            JSON.stringify(assetConsumerMap)
        }`);
    ...
    update: async function (req, res) {
        ...
        if (updatedAssetConsumerMap) {
            sails.log(`Updated the AssetConsumerMap of id ${id} with ${
