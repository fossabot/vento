...
module.exports = {
    create: async function (req, res) {
        ...
        for (let department of departments) {
            let payload = APIUtil.getCreatePayload(department);
            let createdDepartment = await Department.createEach(payload).fetch();
            createdDepartments.push(createdDepartment[0]);
        }

        sails.log(`Created the department(s) successfully: ${
            JSON.stringify(createdDepartments)
        }`);
    ...
    get: async function (req, res) {
        ...
        sails.log(`Fetched all the departments successfully: ${
    ...
    getById: async function (req, res) {
        ...
        sails.log(`Fetched the department details by ${id}: ${
    ...
    update: async function (req, res) {
        ...
        if (updatedDepartment) {
            sails.log(`Updated the department of id ${id} with ${
