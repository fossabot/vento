...
module.exports = {
    create: async function (req, res) {
        ...
        sails.log(`Created the Roles(s) successfully: ${
            JSON.stringify(createdRoles)
        }`);
    ...
    get: async function (req, res) {
        ...
        sails.log(`Fetched all Roles(s) successfully: ${
    ...
    getById: async function (req, res) {
        ...
        for (let permission of role.permissions) {
            var permissionRecord = await Permission.findOne({
                where: {
        ...
        sails.log(`Fetched the Role details by ${id}: ${
            JSON.stringify(role)
        }`);
    ...
    update: async function (req, res) {
        ...
        if (updatedRole) {
            sails.log(`Updated the role of id ${id} with ${
